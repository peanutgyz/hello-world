# tantan OpenAPI Specification
[![Build Status](https://travis-ci.org/peanutgyz/hello-world.svg?branch=master)](https://travis-ci.org/peanutgyz/hello-world)
...
6. If you did everything correct, https://peanutgyz.github.io/hello-world/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://peanutgyz.github.io/hello-world/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://peanutgyz.github.io/hello-world/ with url from the message: `Server started <url>`
